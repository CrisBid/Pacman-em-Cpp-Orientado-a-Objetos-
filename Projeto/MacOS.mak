...
ALLEGRO_FLAGS_MAIN=-L/usr/local/lib `pkg-config --libs allegro-5 allegro_main-5 allegro_audio-5 allegro_dialog-5 allegro_image-5 allegro_memfile-5 allegro_primitives-5 allegro_acodec-5 allegro_color-5 allegro_font-5 allegro_physfs-5 allegro_ttf-5` 

ALLEGRO_FLAGS=-L/usr/local/lib `pkg-config --libs allegro-5 allegro_main-5 allegro-5 allegro_audio-5 allegro_dialog-5 allegro_image-5 allegro_memfile-5 allegro_primitives-5 allegro_acodec-5 allegro_color-5 allegro_font-5 allegro_physfs-5 allegro_ttf-5` 
...
all: ./Codigo/Mapa.o ./Codigo/Pirula.o ./Codigo/Tijolinho.o ./Codigo/Placar.o ./Codigo/Matriz.o ./Codigo/Display.o ./Codigo/Inimigos.o ./Codigo/Pacman.o ./Codigo/Movimentacao.o Main.o
	$(COMPILADOR) ./Codigo/Mapa.o ./Codigo/Pirula.o ./Codigo/Tijolinho.o ./Codigo/Placar.o ./Codigo/Matriz.o ./Codigo/Display.o ./Codigo/Inimigos.o ./Codigo/Pacman.o ./Codigo/Movimentacao.o Main.o -o Main $(ALLEGRO_INCLUDE) $(ALLEGRO_FLAGS_MAIN)
